...
console.log(`
---------------------------------------------------------------------------------------------
1. Mapping with Literals
---------------------------------------------------------------------------------------------`);
console.log(`1. Literals Map example`);
...
function buildHTML2 (tags, lines) {
   return function(element){
     ...
     console.log(finalHTML); //document.querySelector(element).innerHTML += finalHTML
   }
}
console.log(`
...
console.log(`
---------------------------------------------------------------------------------------------
1. Mapping with Literals: Literal Callback
---------------------------------------------------------------------------------------------`);
...
console.log(templateLiteralCallback); //wrong way

function taggedCallback(strings, func){
    return strings[0]+func(); //correct way
}
